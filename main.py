...
words = ['топор', 'утро', 'небо', 'пирог', 'часы', 'флаг',
         'гора', 'змея', 'каникулы', 'стул', 'кот', 'собака',
         'гвоздь', 'корт', 'коловорот', 'хлеб', 'письмо', 'фрукт',
         'алмаз', 'поезд', 'калькулятор', 'рюкзак', 'карат']
n = ''
